    ...
    return (
        <div className=" text-center mt-10">
            ...
            <div className="grid  pb-10 px-10 lg:grid-cols-5 md:grid-cols-2  md:justify-items-center ">
                <img src={travellerchoice} alt="" className=" mt-4 w-[180px] h-[200px] ml-4 text-center " />
                ...
                <img src={expedia} alt="" className="w-[180px] sm:pt-9 md:pt-9 text-center " />
                ...
                <a href="https://www.getyourguide.com/reykjavik-l30/from-reykjavik-fagradalsfjall-volcano-helicopter-flight-t418541/">
                    <img src={getyourguide} alt="" className="h-[150px] ml-4 text-center sm:pt-9 lg:pt-9" />
                </a>
            </div>
        </div>
    );
